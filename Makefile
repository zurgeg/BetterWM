...
wmmitm: wmmitm.c wiimote.c input.c wm_crypto.c wm_reports.c wm_print.c sdp.c oui.c bdaddr.c adapter.c
	gcc $(CFLAGS) -o wmmitm wmmitm.c wiimote.c input.c wm_crypto.c wm_reports.c wm_print.c sdp.c oui.c bdaddr.c adapter.c $(LBLUETOOTH) -lSDL -lpthread -lm $(LDBUS) -Wall
